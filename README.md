...
Try:  
$t_1 \leq \frac{y_2}{y_3}  &rarr;$ $`t_1 = \begin{cases} 0 & \text{if } y_2 \lt y_3 \\ 0,1 & \text{if } y_2 \geq y_3 &rarr; \text{not restrictive enough but could work in combo with other constraints}\end{cases}`$  
